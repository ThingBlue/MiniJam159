...
{
    public class SteelResource : MonoBehaviour, IResource
    {
        ...
        public void replenishResource()
        {
            ...
            resourceAmount = Mathf.Min(resourceAmount, 200f); // Assume 200 is the max resource amount
        }
    }
}
